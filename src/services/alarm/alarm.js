...
export const createAlarm = async ({
  ...
  return await axiosForm(
    process.env.REACT_APP_SERVER_URL + "/alarm/create",
    form
  );
};
...
export const updateAlarm = async ({
  ...
  return await axiosForm(
    process.env.REACT_APP_SERVER_URL + "/alarm/update",
    form
  );
};
...
export const deleteAlarm = async (alarmId) => {
  ...
  return await axiosForm(process.env.REACT_APP_SERVER_URL + "/alarm/delete", {
    alarmId,
  });
};
...
export const updateEmail = async (email) => {
  return await axiosForm(
    process.env.REACT_APP_SERVER_URL + "/alarm/updateMethod",
    { email }
  );
};
